...
if __name__ == "__main__":
    setup_logging(os.path.join('data', 'results', 'logs', 'utilities.log'))
    ...
    ensure_directory(os.path.join('data', 'output'))
    ensure_directory(os.path.join('data', 'results', 'detection_images'))

    movement = calculate_movement((100.0, 150.0), (130.0, 180.0))
    print(f"Movement distance: {movement} pixels.")

    formatted_time = format_timestamp(3661.75)
